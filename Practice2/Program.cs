namespace Practice2
{
    internal class Program
    {
        ...
        static void PlayerBattleMain()
        {
            ...
            {
                Console.WriteLine("공격전, 플레이어의 공격력: " + nPlayerAtk + " 몬스터의 남은 hp:" + nMonsterHP);
                nMonsterHP -= nPlayerAtk;
                Console.WriteLine("공격후, 플레이어의 공격력: " + nPlayerAtk + " 몬스터의 남은 hp:" + nMonsterHP);
                Console.WriteLine("공격전, 몬스터의 공격력: " + nMonsterAtk + " 플레이어의 남은 hp:" + nPlayerHP);
                nPlayerHP -= nMonsterAtk;
                Console.WriteLine("공격후, 몬스터의 공격력: " + nMonsterAtk + " 플레이어의 남은 hp:" + nPlayerHP);
